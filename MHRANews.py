...
class MHRANews(scrapy.Spider):
    name = 'MHRANews'

    start_urls = ['https://www.gov.uk/search/news-and-communications?organisations%5B%5D=medicines-and-healthcare-products-regulatory-agency&page=']
    ...
    def __init__(self, max_items=20, output_file='MHRANews.xlsx', *args, **kwargs):
